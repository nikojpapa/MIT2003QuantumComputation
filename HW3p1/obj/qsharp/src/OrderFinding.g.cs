...
[assembly: OperationDeclaration("HW3p1", "QuantumPow (powQ : Qubit[], baseQ : Qubit[], target : Qubit[], depth : Int, currentProduct : Qubit[]) : ()", new string[] { "Controlled", "Adjoint" }, "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs", 4367L, 124L, 115L)]
[assembly: OperationDeclaration("HW3p1", "_TestOrderFindingQuantumPowImpl (q1 : Qubit[], q2 : Qubit[], N : Int) : ()", new string[] { }, "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs", 5378L, 150L, 85L)]
[assembly: OperationDeclaration("HW3p1", "_TestOrderFindingQuantumPow (binaryLength : Int, N : Int) : ()", new string[] { }, "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs", 6133L, 170L, 74L)]
#line hidden
namespace HW3p1
{
...
#line 110 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
                Multiplier.Apply((ancillas2, baseQ, ancillas1));
#line 111 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
...
#line 114 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
...
#line 126 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
...
#line 128 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
                QFTAdder.Apply((target, currentProduct));
            }
            else
            {
...
#line 131 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
...
#line 133 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
                var ancillas2 = ancillas?.Slice(new Range(targetLength, (ancillas.Count - 1L)));
#line 134 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
                var control = powQ[((powQ.Count - 1L) - depth)];
#line 136 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
...
#line 140 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
...
#line hidden
        ...
        public override Func<(QArray<Qubit>,QArray<Qubit>,QArray<Qubit>,Int64,QArray<Qubit>), QVoid> AdjointBody => (__in) =>
        {
            ...
            if ((depth == powQ.Count))
            {
                QFTAdder.Adjoint.Apply((target, currentProduct));
            }
            else
            {
#line 130 "/Users/nicholaspapadopoulos/Box Sync/CS/Me/quantum/MIT2003QuantumComputation/HW3p1/OrderFinding.qs"
...
#line hidden
        ...
        public override Func<(QArray<Qubit>,(QArray<Qubit>,QArray<Qubit>,QArray<Qubit>,Int64,QArray<Qubit>)), QVoid> ControlledBody => (__in) =>
        {
            ...
            if ((depth == powQ.Count))
            {
                QFTAdder.Controlled.Apply((controlQubits, (target, currentProduct)));
            }
            else
            {
                var targetLength = target.Count;
...
#line hidden
        ...
        public override Func<(QArray<Qubit>,(QArray<Qubit>,QArray<Qubit>,QArray<Qubit>,Int64,QArray<Qubit>)), QVoid> ControlledAdjointBody => (__in) =>
        {
            ...
            if ((depth == powQ.Count))
            {
                QFTAdder.Adjoint.Controlled.Apply((controlQubits, (target, currentProduct)));
            }
            else
            {
                var targetLength = target.Count;
